...
rh.consts('DEFAULT_TOPIC', encodeURI("#Ch14/Ch14.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '3CCB7440-F3C9-47B2-BB6C-F1B327287C16' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "ELO ConLaw ch14 in Resp HTML5");
